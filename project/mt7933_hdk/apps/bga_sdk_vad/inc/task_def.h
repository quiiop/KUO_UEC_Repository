...
#else /* #if defined(MTK_PORT_SERVICE_ENABLE) */
...
#endif /* #if (PRODUCT_VERSION == 7687) || (PRODUCT_VERSION == 7697) || (PRODUCT_VERSION == 7686) || (PRODUCT_VERSION == 7682) || (PRODUCT_VERSION == 5932) || (PRODUCT_VERSION == 7933) || defined(MTK_NO_PSRAM_ENABLE) */
...
#define wifi_auto_init_TASK_NAME        "wifi_auto_init_task"
#define wifi_auto_init_TASK_STACKSIZE   (8192)
#define wifi_auto_init_TASK_PRIO        TASK_PRIORITY_NORMAL

#define audio_init_TASK_NAME            "audio_init_task"
#define audio_init_TASK_STACKSIZE       (1024)
#define audio_init_TASK_PRIO            TASK_PRIORITY_NORMAL
...
#else /* #ifdef MTK_AUDIO_TUNING_ENABLED */
#define ATCI_TASK_STACKSIZE         (1024*4) /*unit byte!*/
#endif /* #ifdef MTK_AUDIO_TUNING_ENABLED */
#define ATCI_TASK_PRIO              TASK_PRIORITY_NORMAL

#endif /* #ifndef __TASK_DEF_H__ */
